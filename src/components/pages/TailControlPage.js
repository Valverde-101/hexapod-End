...
import TailDimensionsWidget from "../pagePartials/TailDimensionsWidget"
...
class TailControlPage extends Component {
    ...
    updateDimensions = dimensions => {
        this.props.onUpdate("tailDimensions", { tailDimensions: dimensions })
    }
    ...
    render() {
        ...
        return (
            <div>
                <TailDimensionsWidget
                    dimensions={this.props.params.tailDimensions}
